...
module.exports = {
    posts: {
        ...
        created_by_type: {type: 'string', maxlength: 24, defaultTo: 'user'},
        updated_at: {type: 'dateTime', nullable: true},
        updated_by: {type: 'string', maxlength: 24, nullable: true},
        updated_by_type: {type: 'string', maxlength: 24, defaultTo: 'user'},
        published_at: {type: 'dateTime', nullable: true},
        published_by: {type: 'string', maxlength: 24, nullable: true},
        published_by_type: {type: 'string', maxlength: 24, defaultTo: 'user'},
