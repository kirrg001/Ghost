module.exports = {
    posts: {
        ...
        previewId: {type: 'string', maxlength: 36, nullable: false, validations: {isUUID: true}},
    ...
    posts_tags: {
        id: {type: 'increments', nullable: false, primary: true},
        post_id: {type: 'string', nullable: false, unsigned: true, references: 'posts.id'},
        tag_id: {type: 'string', nullable: false, unsigned: true, references: 'tags.id'},
    ...
    app_settings: {
        ...
        key: {type: 'string', maxlength: 150, nullable: false, unique: true},
        value: {type: 'text', maxlength: 65535, nullable: true},
        app_id: {type: 'string', nullable: false, unsigned: true, references: 'apps.id'},
        created_at: {type: 'dateTime', nullable: false},
        created_by: {type: 'string', nullable: false},
        updated_at: {type: 'dateTime', nullable: true},
        updated_by: {type: 'string', nullable: true}
    ...
    app_fields: {
        ...
        app_id: {type: 'string', nullable: false, unsigned: true, references: 'apps.id'},
        relatable_id: {type: 'string', nullable: false, unsigned: true},
    ...
    client_trusted_domains: {
        id: {type: 'increments', nullable: false, primary: true},
        client_id: {type: 'string', nullable: false, unsigned: true, references: 'clients.id'},
        trusted_domain: {type: 'string', maxlength: 2000, nullable: true}
    },
    accesstokens: {
        id: {type: 'string', nullable: false, primary: true},
        token: {type: 'string', nullable: false, unique: true},
        user_id: {type: 'string', nullable: false, unsigned: true, references: 'users.id'},
        client_id: {type: 'string', nullable: false, unsigned: true, references: 'clients.id'},
    ...
    subscribers: {
        ...
        post_id: {type: 'string', nullable: true, unsigned: true, references: 'posts.id'},
