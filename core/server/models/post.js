...
Post = ghostBookshelf.Model.extend({
     ...
     * `onSaved` is the last event in the line - triggered for update or insert.
     * bookshelf-relations only listens on `saved` event currently, this can clash
     * with `created` - because it is triggered earlier.
     */
