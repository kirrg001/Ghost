...
module.exports = function apiRoutes() {
    ...
    // ## Posts
    apiRouter.get('/posts', mw.authenticatePrivate, api.http(api.posts.browse));
    apiRouter.post('/posts', mw.authenticatePrivate, api.http(api.posts.add));
    apiRouter.get('/posts/:id', mw.authenticatePrivate, api.http(api.posts.read));
    apiRouter.get('/posts/slug/:slug', mw.authenticatePrivate, api.http(api.posts.read));
    ...
    // ## Users
    apiRouter.get('/users', mw.authenticatePrivate, api.http(api.users.browse));
    apiRouter.get('/users/:id', mw.authenticatePrivate, api.http(api.users.read));
    apiRouter.get('/users/slug/:slug', mw.authenticatePrivate, api.http(api.users.read));
    ...
    // ## Tags
    apiRouter.get('/tags', mw.authenticatePrivate, api.http(api.tags.browse));
    apiRouter.get('/tags/:id', mw.authenticatePrivate, api.http(api.tags.read));
    apiRouter.get('/tags/slug/:slug', mw.authenticatePrivate, api.http(api.tags.read));
    ...
    apiRouter.post('/subscribers', labs.subscribers, mw.authenticatePrivate, api.http(api.subscribers.add));
