...
DataGenerator.forKnex = (function () {
    ...
    invites_roles = [
        {id: ObjectId.generate(), invite_id: invites[0].id, role_id: DataGenerator.Content.roles[0].id},
        {id: ObjectId.generate(), invite_id: invites[1].id, role_id: DataGenerator.Content.roles[2].id}
    ];
