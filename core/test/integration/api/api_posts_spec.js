...
describe('Post API', function () {
    ...
    describe('Read', function () {
        ...
        it('can fetch post with by id', function (done) {
            PostAPI.read({context: {user: '1'}, id: testUtils.DataGenerator.Content.posts[1].id, status: 'all'}).then(function (results) {
                should.exist(results.posts);
        ...
        it('can include tags', function (done) {
            PostAPI.read({context: {user: '1'}, id: testUtils.DataGenerator.Content.posts[2].id, include: 'tags'}).then(function (results) {
        ...
        it('can include author', function (done) {
            PostAPI.read({context: {user: '1'}, id: testUtils.DataGenerator.Content.posts[1].id, include: 'author'}).then(function (results) {
                should.exist(results.posts[0].author.name);
                results.posts[0].author.name.should.eql('Joe Bloggs');
                done();
            }).catch(done);
        ...
        it('can include next post', function (done) {
            PostAPI.read({context: {user: '1'}, id: testUtils.DataGenerator.Content.posts[2].id, include: 'next'}).then(function (results) {
        ...
        it('can include next post with author and tags', function (done) {
            PostAPI.read({context: {user: '1'}, id: testUtils.DataGenerator.Content.posts[2].id, include: 'next,next.tags,next.author'}).then(function (results) {
                should.exist(results.posts[0].next.slug);
                results.posts[0].next.slug.should.eql('not-so-short-bit-complex');
        ...
        it('can include next post with just tags', function (done) {
            PostAPI.read({context: {user: 1}, id: testUtils.DataGenerator.Content.posts[1].id, include: 'next,next.tags'}).then(function (results) {
                should.exist(results.posts[0].next.slug);
        ...
        it('can include previous post', function (done) {
            PostAPI.read({context: {user: 1}, id: testUtils.DataGenerator.Content.posts[2].id, include: 'previous'}).then(function (results) {
        ...
        it('can include previous post with author and tags', function (done) {
            PostAPI.read({context: {user: 1}, id: testUtils.DataGenerator.Content.posts[2].id, include: 'previous,previous.author,previous.tags'}).then(function (results) {
                should.exist(results.posts[0].previous.slug);
                results.posts[0].previous.slug.should.eql('ghostly-kitchen-sink');
        ...
        it('can include previous post with just author', function (done) {
            PostAPI.read({context: {user: 1}, id: testUtils.DataGenerator.Content.posts[2].id, include: 'previous,previous.author'}).then(function (results) {
                should.exist(results.posts[0].previous.slug);
    ...
    describe('Destroy', function () {
        it('can delete a post', function (done) {
            var options = {context: {user: 1}, id: testUtils.DataGenerator.Content.posts[0].id};
        ...
        it('returns an error when attempting to delete a non-existent post', function (done) {
            var options = {context: {user: 1}, id: ObjectId.generate()};
    ...
    describe('Edit', function () {
        it('can edit own post', function (done) {
            PostAPI.edit({posts:[{status: 'test'}]}, {context: {user: 1}, id: testUtils.DataGenerator.Content.posts[0].id}).then(function (results) {
                should.exist(results.posts);
                done();
            }).catch(done);
        });
